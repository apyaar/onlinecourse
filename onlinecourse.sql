...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2023 at 07:53 PM
...
CREATE TABLE `students` (
  ...
  `optional_core_choice_1` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  `optional_core_choice_2` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  `optional_core_choice_3` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
...
(7, 'IMTECH 7-8', 50, 5, 0, 50, 50, 50, 15, 0, 50, 50, 50, 50, 50, 0, 0, 15, 50, 50, 50),
